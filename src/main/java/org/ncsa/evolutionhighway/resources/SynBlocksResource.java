...
public class SynBlocksResource {
    ...
    public List<AncestorRegion> getSynBlocks() {
        ...
        for (Object[] synBlock : getSynBlocksFromDB())
            ancestorRegions.add(new AncestorRegion((Long)synBlock[0], (Long)synBlock[1], (String)synBlock[2], (Integer)synBlock[3], (Long)synBlock[4], (Long)synBlock[5], (String)synBlock[6]));
